...
**V0.5 — live AI recommendation + Resource Health V0.2 + Resource Detail V1.1**
...
- Responsive per-resource detail dialog
...
- Dedicated standalone per-resource routes/pages if the modal detail view later needs shareable URLs
