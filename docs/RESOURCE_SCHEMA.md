...
`data/resources.json` is the canonical V0.1 catalog.
...
```json
{
  ...
  "use_cases": ["Build coding workflows"],
  "pricing": "free",
  "open_source": true,
  "license": "MIT",
...
### `tags`
Lower-case retrieval terms. Prefer specific capabilities over marketing language.
...
5. Validate the complete JSON document after editing.
