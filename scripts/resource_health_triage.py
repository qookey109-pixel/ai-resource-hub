...
def markdown_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "## Metadata freshness evidence",
        "",
        f"- Checked within 14 days: {report.get('raw_summary', {}).get('metadata_checked_within_14d', '—')}",
        f"- Older than 14 days: {report.get('raw_summary', {}).get('metadata_older_than_14d', '—')}",
        f"- Older than 30 days: {report.get('raw_summary', {}).get('metadata_older_than_30d', '—')}",
        f"- Oldest check age: {report.get('raw_summary', {}).get('oldest_metadata_check_age_days', '—')} days",
        "",
